...
export const useLiveMatch = (
    ...
    const playBall = useCallback(() => {
        setState((prevState: LiveMatchState | null) => {
            ...
            if (strategies.batting === 'ultra_attacking') { strategyRunMod *= 1.8; strategyWicketMod *= 1.5; }
            else if (strategies.batting === 'attacking') { strategyRunMod *= 1.4; strategyWicketMod *= 1.2; }
            else if (strategies.batting === 'defensive') { strategyRunMod *= 0.8; strategyWicketMod *= 0.7; }
            else if (strategies.batting === 'ultra_defensive') { strategyRunMod *= 0.6; strategyWicketMod *= 0.5; }

            if (strategies.bowling === 'ultra_attacking') { strategyWicketMod *= 1.5; strategyRunMod *= 1.6; }
            else if (strategies.bowling === 'attacking') { strategyWicketMod *= 1.2; strategyRunMod *= 1.3; } 
            else if (strategies.bowling === 'defensive') { strategyWicketMod *= 0.8; strategyRunMod *= 0.8; }
            else if (strategies.bowling === 'ultra_defensive') { strategyWicketMod *= 0.6; strategyRunMod *= 0.75; }
