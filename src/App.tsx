    ...
    >
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-[10px] md:text-xs font-black text-white/30 uppercase tracking-[0.6em]">v.0.0.1.1 // EARLY_ACCESS_UPDATES</p>
          <div className="max-w-xs mx-auto mt-4 p-4 glass-card border border-white/5 rounded-2xl">
            <h4 className="text-[10px] font-black text-teal-500 uppercase tracking-widest mb-2">Change Log</h4>
            <ul className="text-[8px] text-white/40 uppercase tracking-wider space-y-1 text-left list-disc list-inside">
              <li>NEW TOURNAMENT SYSTEM: 6-TEAM LEAGUE + 10-TEAM QUALIFIERS</li>
              <li>AGRESSION CONTROL: 5-TIER STRATEGY LOGIC</li>
              <li>REDESIGNED MODERN MATCH UI / SCOREBOARD</li>
              <li>IMPROVED PWA & HOSTING STABILITY</li>
            </ul>
          </div>
        </div>
...
export const App = () => {
  ...
  const initializeNewGame = (userTeamId: string) => {
    ...
    // Automated Group Distribution (Elite vs Qualifiers)
    ...
    const rankedTeamsWithRatings: Team[] = rankedTeamsRaw.map(team => {
        ...
        // User request: 6 teams play main league, 10 teams qualifiers.
        const groupKey = rank <= 6 ? 'Round-Robin' : 'Group A';
